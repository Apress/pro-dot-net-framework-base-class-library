...
-> As soluções, os projetos, códigos de exemplo, arquivos de suporte requeridos, códigos que são integralmente ou parcialmente inclusos no texto da newsletter como parte de cada
edição do ROGERVILLELA JOURNAL são construídos conforme os seguintes critérios mínimos:

		-> Utilizam o Microsoft Windows 10 Creators Update (RTM) como plataforma mínima.
		-> Utilizam a versão mais recente do Microsoft Windows 10 (RTM) conforme disponibilizada.
		-> Utilizam o Microsoft Visual Studio 2017 (RTM) como plataforma mínima.
		-> Utilizam a versão mais recente do Microsoft Visual Studio 2017 (RTM) conforme disponibilizada.
		-> Utilizam a versão mais recente do Microsoft Windows SDK (RTM) para Microsoft Windows 10 (RTM) conforme disponibilizado.
		-> Utilizam a versão .NET Framework 4.0 (RTM) como versão mínima.
		-> Utilizam a versão mais recente do .NET Framework (RTM) a partir do critério de versão mínima e conforme disponibilizada.
...
edição do ROGERVILLELA JOURNAL são construídos conforme os seguintes critérios mínimos:
	...
	-> Utilizam o Microsoft Windows 10 Creators Update (RTM) como plataforma mínima.
	-> Utilizam a versão mais recente do Microsoft Windows 10 (RTM) conforme disponibilizada.
	-> Utilizam o Microsoft Visual Studio 2017 (RTM) como plataforma mínima para ambiente de integração.
	-> Utilizam a versão mais recente do Microsoft Visual Studio 2017 (RTM) conforme disponibilizada.
	-> Utilizam a versão mais recente do Microsoft Windows SDK (RTM) para Microsoft Windows 10 (RTM) conforme disponibilizado.
	-> Utilizam Intel Parallel Studio 2018 como plataforma mínima.
	-> Utilizam a versão mais recente do Intel Parallel Studio a partir do critério de versão mínima e conforme disponibilizada.



INTEL C++ / MICROSOFT VISUAL C++

-> O código fundamental compila com outras versões do Intel C++ / Microsoft Visual C++, desde que haja suporte para os recursos
...
do Intel C++ / Microsoft Visual C++, ajustes podem ser necessários.
...
para Microsoft Windows 10 (RTM). No entanto, são compatíveis com o Microsoft Windows SDK 10.0.10240.0 em diante.
