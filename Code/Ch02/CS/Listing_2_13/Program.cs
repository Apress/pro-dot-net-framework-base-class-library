...
namespace RVJ.Listing_2_13 {
	...
	public class Program {
		...
		public static void Main() {
			...
			// This is not the recommended way to create instances of single-dimensional or multidimensional arrays.
			...
			for ( index = new Int32(); index != length; index++ )
				Console.WriteLine( "Value: {0} at index {1}\n", otherArray.GetValue( index ), index.ToString() );
