...
namespace RVJ.Listing_2_25 {
	...
	public class Program {
		...
		#region Support function(s)

		public static void Pause( Boolean finish = false ) {
		...
		public static void Main() {
			...
			Object[,] objects = new Object[,]{ { new Person( "A" ) }, { "C# programming language" }, { 10 } };
			Array moreObjects = new Object[,]{ { new Person( "A" ) }, { "C# programming language" }, { 10 } };
