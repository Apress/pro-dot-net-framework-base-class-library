...
namespace RVJ.Listing_2_4 {
	...
	public class Program {
		...
		public static void Main() {
			...
			Person[] peopleTwo = new Person[] { new Person( "A" ), new Person( "B" ), new Person( "C" ) };
			Person[] peopleThree = new Person[ 3 ] { new Person( "A" ), new Person( "B" ), new Person( "C" ) };
