...
void wmain() {
	...
	Using complete implementation of Person.

	::cli::array<Person^>^ people = { gcnew Person("A"), gcnew Person("B"), gcnew Person("C") };

	*/

	/*

	Using a simple implementation of Person.


	*/

	::cli::array<Person^>^ people = { gcnew Person(), gcnew Person(), gcnew Person() };


	::cli::array<Int32>^ numbers = { 0i32, 1i32, 2i32, 3i32 };

	::cli::array<Person^>^ clonePeople = safe_cast<::cli::array<Person^>^>(people->Clone());
	::cli::array<Int32>^ cloneNumbers = safe_cast<::cli::array<Int32>^>(numbers->Clone());
