...
#pragma region Person reference type.

namespace RVJ {

	public ref class Person : ICloneable, IBusiness<Person^> {
	...
	public:
		...
		Person( String^ newName, Int32 newAge ) : Person( newName ) {
	...
	public:
		...
		property Int32 Age {
			Int32 get() { return this->age; };
		};

	public:

		virtual Boolean Equals( Object^ anotherPerson ) override {
			return this->__is_equal_Person( dynamic_cast< Person^ >( anotherPerson ) );
		};
	...
	public:
		...
		virtual Person^ Clone( CloneType operationType ) = IBusiness<Person^>::Clone{

			/* Replace nullptr by an internal implementation for a deep clone operation. */
			return ( ( operationType == CloneType::Shallow ) ? safe_cast< Person^ >( ( ( ICloneable^ ) this )->Clone() ) : nullptr );
