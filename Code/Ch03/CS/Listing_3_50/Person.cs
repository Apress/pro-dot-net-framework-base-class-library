...
namespace RVJ {
	...
	*/
		...
		public class Person: ICloneable, IBusiness<Person> {
		...
		public Person( String newName, Int32 newAge ) : this( newName ) {
		...
		#region Override of Object.ToString()
		...
		#region Override of Object.Equals() method

		public override Boolean Equals( Object anotherPerson ) {
			return this.__is_equal( ( anotherPerson as Person ) );
		}

		#endregion

		#region Override of Object.GetHashCode() method.

		public override Int32 GetHashCode() { return this.GetHashCode(); }

		#endregion

		#region Custom implementation of operators == and !=

		public static Boolean operator ==( Person me, Person other ) { 
		...
		#region Implementation of the ICloneable interface member and Object.MemberwiseClone() method.
		...
		#region Implementation of the IBusiness interface

		Person IBusiness<Person>.Clone( CloneType operationType ) 	{
			return ( ( operationType == CloneType.Shallow ) ? ( ( ( ICloneable ) this ).Clone() as Person ) :
			null );
			{ /* Replace null by an internal implementation for a deep clone operation. */ }
		}
		#endregion
		...
		private void _Validate_Name( String proposedName ) {
			if ( proposedName != null ) this._name.Clear().Append( proposedName );
			else this._name.Clear().Append( System.String.Empty );
		}

		private static Boolean _is_Name_Empty( String proposedName ) {

			return String.IsNullOrEmpty( proposedName );

		}



		private static String _validate_Name( String proposedName ) {
			return ( ( !Person._is_Name_Empty( proposedName ) ? String.Intern( proposedName ) : String.Empty ) );
		}

		private Boolean __is_equal( Person otherPerson ) {
			return ( ( Person.ReferenceEquals( this, otherPerson ) ) && ( this.Name == otherPerson.Name ) );
		}
